...
# Step 1: Login
login_data = {
    "j_username": "pavly.nashed@trilogy.com",
    "j_password": "Firm58pavly",
}
...
def guzmanExtract():
    ...
    if login_response.status_code == 200:
        ...
        headers = {
            ...
            "X-GWT-Permutation": "5717AD49473235236F3456356C0B2594",  # Replace with your actual x-gwt-permutation value
        }
